...
export const CartButtons = () => {
  ...
  return (
    <div className="countBox">
      <button onClick={handleLessClick} className="customCard-button countBtn">-</button>
      <input
        type="text"
        ...
        readOnly
      />
      <button onClick={handleMoreClick} className="customCard-button countBtn">+</button>
      <button className="customCard-button" onClick={addToCart}>
